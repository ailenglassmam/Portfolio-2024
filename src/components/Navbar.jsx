...
export default function Navbar() {
  ...
  return (
    <header className='w-full md:w-1/2 md:mt-4 md:mx-auto md:rounded-xl bg-second-background text-main-background fixed z-50 h-fit md:left-1/2 md:-translate-x-1/2'>
      <nav className='py-5'>
        <ul className='hidden list-none md:flex md:flex-row md:gap-7 md:justify-center'>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#home' data-section='navbar' data-value='link1'>Inicio.</a></li>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#aboutMe' data-section='navbar' data-value='link2'>Sobre Mi.</a></li>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#experience' data-section='navbar' data-value='link3'>Experiencia.</a></li>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#projects' data-section='navbar' data-value='link4'>Proyectos.</a></li>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#education' data-section='navbar' data-value='link5'>Educación.</a></li>
          <li className='font-medium md:hover:text-link-hover md:hover:cursor-pointer md:transition-colors'><a href='#contact' data-section='navbar' data-value='link6'>Contacto.</a></li>
        </ul>
        {/* responsive dropdown menu */}
        <div className='md:hidden w-full fixed bg-second-background text-white z-50 pb-3'>
          ...
          {isMenuOpen && (
            <div className='absolute top-20 px-5 w-screen'>
              <div className='p-5 bg-second-background text-white rounded-lg shadow-lg'>
